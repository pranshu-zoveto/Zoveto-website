...
const faqs = [
  {
    ...
    a: "It is a 0 to 100 diagnostic score that estimates how independently a business can run when the owner is unavailable. Higher scores mean fewer owner bottlenecks.",
  },
  {
    q: "How is the score calculated?",
    a: "The score uses weighted answers across pricing authority, approvals, institutional knowledge, decision latency, relationship concentration, and succession readiness.",
  },
  {
    q: "Is this a financial audit?",
    a: "No. It is an operational diagnostic for owner dependency. It helps identify where systems, dashboards, delegation, and process documentation can reduce daily owner involvement.",
  },
  {
    q: "Who should use this calculator?",
    a: "Founder-led SMBs, distributors, manufacturers, trading businesses, service companies, and growing teams where the owner is still pulled into daily decisions.",
  },
  {
    q: "How can Zoveto help improve the score?",
    a: "Zoveto helps centralize workflows, dashboards, approvals, SOPs, customer records, inventory, sales, finance, HR, and alerts so decisions move through the business instead of through the owner.",
  },
];
      ...
      <div className="container relative z-10 mx-auto max-w-content px-4 sm:px-6">
        <header className="mx-auto max-w-4xl text-center">
          <Text variant="label-uppercase" className="mb-4 text-muted-2">
            Free founder-led business diagnostic
          </Text>
          ...
          <p className="mx-auto mt-6 max-w-3xl text-balance text-[1.125rem] leading-8 tracking-[0] text-muted md:text-[1.25rem] md:leading-9">
            ...
            knowledge still depend on the owner.
          </p>
        </header>
        ...
        <section className="mx-auto mt-16 max-w-3xl space-y-6 md:mt-20" aria-labelledby="owner-dependency-faq-heading">
          ...
          <p className="text-sm text-muted">
            Want to connect the score to live operating data?{" "}
