    ...
    <>
      {showBottomBanner && (
        <div
          ...
          className="pointer-events-none fixed inset-x-0 bottom-[max(0.75rem,env(safe-area-inset-bottom))] z-[120] flex justify-center px-3 pt-2 sm:px-4 md:bottom-[max(1.25rem,env(safe-area-inset-bottom))]"
        >
