  ...
  return (
    ...
    >
      <div className="container relative z-10 mx-auto max-w-content space-y-8 px-4 sm:px-6 md:space-y-12">
        <div>
          <h2 className="mx-auto mb-4 max-w-4xl text-balance text-[clamp(1.95rem,5vw,3.9rem)] font-bold leading-[1.08] tracking-tight text-foreground">
            Run the company on <span className="text-blue">one stack</span>
          </h2>
          <p className="mx-auto max-w-2xl text-[15px] leading-relaxed text-muted sm:text-base md:text-lg">
        ...
        {/* Trust micro-copy — visible on sm+ only, too cluttered on tiny screens */}
        <div className="hidden flex-wrap items-center justify-center gap-8 pt-2 sm:flex md:gap-12">
          {[
        ...
        {/* Mobile-only: single-line trust signal */}
        <p className="text-xs text-muted-2 sm:hidden">Reviewed access · Manual onboarding · Fit check required</p>
      </div>
