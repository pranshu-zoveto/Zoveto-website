...
export const INDEXABLE_STATIC_PAGES: readonly StaticSitemapPage[] = [
  ...
  { path: "/company-facts", changeFrequency: "monthly", priority: 0.7 },
  { path: "/directory", changeFrequency: "monthly", priority: 0.68 },
